...
Процедура ВыемкаДенегЗавершение(ИзымаемаяСумма, ДополнительныеПараметры) Экспорт
	Если ТипЗнч(ИзымаемаяСумма) = Тип("Структура") Тогда
		Сумма = ИзымаемаяСумма.Сумма;
	Иначе
		Сумма = Неопределено;
	КонецЕсли;
	Если Сумма <> Неопределено И ТипЗнч(Сумма) = Тип("Число") Тогда
		...
		РеквизитыВыемкаДенежныхСредствИзКассыККМ.Вставить("СуммаДокумента", Сумма);
		РеквизитыВыемкаДенежныхСредствИзКассыККМ.Вставить("Валюта",         ДополнительныеПараметры.ПараметрыКассыККМ.Валюта);
		РеквизитыВыемкаДенежныхСредствИзКассыККМ.Вставить("АгентскийПлатеж",ИзымаемаяСумма.АгентскийПлатеж);
