...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Запрос.Выполнить();
	//А.М.А.
	Если ОбщегоНазначения.ЕстьРеквизитОбъекта("АгентскийПлатеж", Отбор.Регистратор.Значение.Метаданные())
		И Отбор.Регистратор.Значение.АгентскийПлатеж Тогда
		
		Для Каждого Запись из ЭтотОбъект Цикл
			Запись.СуммаАг = Запись.Сумма;
		КонецЦикла;
	ИначеЕсли ОбщегоНазначения.ЕстьРеквизитОбъекта("СуммаДокументаАг", Отбор.Регистратор.Значение.Метаданные()) Тогда
		Для Каждого Запись из ЭтотОбъект Цикл
			Запись.СуммаАг = Отбор.Регистратор.Значение.СуммаДокументаАг;
		КонецЦикла;
	КонецЕсли;
КонецПроцедуры
