...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(Запрос, ТекстыЗапроса)
	...
	|	ТаблицаРасхождения.НДСРегл КАК ВременнаяРазница,
...
Процедура ОтразитьВУчетеНДС(Запрос, ТекстыЗапроса, Регистры)
	...
	|   Расхождения.Номенклатура.ОтражатьВКниге КАК ОтражатьВКниге
	|ИЗ
	...
	|	0 КАК НомерСтроки,
	|	ВидыЗапасов.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|   ВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура.ОтражатьВКниге КАК ОтражатьВКниге
	|ИЗ
